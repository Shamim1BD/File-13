...
ha = current.day
today = date.today()
#Shamim2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mShamim')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Shamim/1.2.0 OPN-B'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Shamim1BD/File1/blob/main/Afroveal13.txt').text
        ff=open('show.txt','w')
...
$$    $$/ $$ |  $$ |$$ |  $$ |$$ | $/  $$ |/ $$   |$$ | $/  $$ |
 ...
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mSHAMIM \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mSHAMIM SARKAR \033[1;92m     |   
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Shamim_OK.mp3")
                print('\033[1;92m[Shamim-OK] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mShamim","\x1b[1;92mShamim","\x1b[1;93mShamim","\x1b[1;94mShamim","\x1b[1;95mShamim","\x1b[1;96mShamim","\x1b[1;97mShamim","\x1b[1;91mShamim","\x1b[1;92mShamim","\x1b[1;93mShamim","\x1b[1;94mShamim","\x1b[1;95mShamim","\x1b[1;96mShamimRitu"])
